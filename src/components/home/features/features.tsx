  ...
  return (
    <div className={`feature ${inverted ? "inverted" : ""}`}>
      ...
      <div className="feature-text">
        <p className="overtitle">{overtitle}</p>
        <h2>{title}</h2>
  ...
  return (
    <div className="section features">
      <Feature
        ...
        title="Visualise ta moyenne générale dans le temps"
        description="Visualise tes notes et ta progression en temps réel, pour mieux comprendre ton évolution."
        checks={[
      ...
      <Feature
        overtitle="Rapide"
        title="Consulte ton emploi du temps en un clin d'œil"
        description="Accède rapidement à ton emploi du temps, où que tu sois, pour ne jamais manquer un cours."
        checks={[
      ...
      <Feature
        ...
        title="Personnalise tes matières à ton image"
        description="Adapte les matières selon tes préférences pour une expérience qui te ressemble."
        checks={[
